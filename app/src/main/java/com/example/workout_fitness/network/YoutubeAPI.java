package com.example.workout_fitness.network;

import android.util.Log;

import com.example.workout_fitness.models_tutorials.JSON_TutorialResponseModel;
...
public class YoutubeAPI {
    ...
    // type=video&
    // key=AIzaSyDxcTHLgcSR2jaOeZdfqcbPEi0fIOhp2EU
    ...
    public static VideoAPI getVideoAPI() {
        if(videoAPI == null) {
            Log.d("YOUTUBE_API", "Creating new instance of Retrofit VideoAPI");
            ...
            Log.d("YOUTUBE_API", "Reusing existing instance of VideoAPI");
        }
        return videoAPI;
    }
}
