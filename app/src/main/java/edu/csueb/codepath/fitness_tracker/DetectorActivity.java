...
import edu.csueb.codepath.fitness_tracker.customview.OverlayView;
import edu.csueb.codepath.fitness_tracker.customview.OverlayView.DrawCallback;
import edu.csueb.codepath.fitness_tracker.env.BorderedText;
import edu.csueb.codepath.fitness_tracker.env.ImageUtils;
import edu.csueb.codepath.fitness_tracker.env.Logger;
import edu.csueb.codepath.fitness_tracker.fragments.FoodFragment;
import edu.csueb.codepath.fitness_tracker.tflite.Classifier;
import edu.csueb.codepath.fitness_tracker.tflite.TFLiteObjectDetectionAPIModel;
import edu.csueb.codepath.fitness_tracker.tracking.MultiBoxTracker;
...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    public static FoodDetectionListener listener = null;
                            ...
                            public void onClick(View v) {
                                for (final Classifier.Recognition result : results) {
                                    ...
                                    if (location != null && result.getConfidence() >= finalMinimumConfidence) {
                                        ...
                                        result.setLocation(location);
                                        mappedRecognitions.add(result);
                                        String detectedFood = result.getTitle();
                                        Log.d("DetectorActivity", "Detected food: " + detectedFood);
                                        Intent resultIntent = new Intent();
                                        resultIntent.putExtra("detected_food", result.getTitle());  // tên món ăn
